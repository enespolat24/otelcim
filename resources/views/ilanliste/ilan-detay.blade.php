...
<div class="row g-5 p-4">
    <div class="col-md-8 py-4">
        ...
        <h1 class="mt-2 text-center mb-4"
    ...
    <div class="col-md-4">
        <div class="card mb-4 text-center p-2">
            ...
            <p class="text-danger">Bu oda için hali hazırda {{Auth::user()->reservations->where('ilan_id',
                $ilan->id)->count()}} adet rezervasyonunuz var</p>
            @endif
            <h1>{{$ilan->fiyat}} - Geceliği</h1>
            <label for="kisiSayi">Kişi Sayısı</label>
            <form action="/rezervasyon-yap" method="POST">
                @csrf
                <input class="mx-auto form-control" type="number" id="kisiSayi" name="kisi_sayi"
                ...
                <input type="date" name="baslangic" class="form-control mx-auto" id="baslangic" min="2018-01-01"
                    max="2025-12-31"><br>
                ...
                <button type="submit" class="btn btn-primary"
                    style="background-color: #913434!important; border-color:#913434">Rezervasyon yap</button>
            </form>
        </div>
        ...
        <div class="position-sticky" style="top: 2rem;">
            <form action="/soru-sor" method="POST">
                @csrf
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex ">
                            <input type="hidden" name="ilan_id" value="{{$ilan->id}}">
                            <textarea class="form-control" type="hidden" placeholder="Lütfen Sorunuzu Yazınız" rows="1" name="soru"></textarea>
                            <button type="submit" class="btn btn-success w-50 mx-auto">Soru Sor</button>
                        </div>
                    </div>
                </div>
        </div>
